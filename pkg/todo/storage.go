...
type Storage interface {
	// GeoJson returns a geoJson of existing todos with the given offset and limit.
	...
	// ListByExternalId returns the list of existing todos having the given externalId with the given offset and limit.
	ListByExternalId(ctx context.Context, offset, limit int, externalId int) ([]*TodoList, error)
	// Search returns the list of existing todos filtered by search params with the given offset and limit.
	Search(ctx context.Context, offset, limit int, params SearchParams) ([]*TodoList, error)
	// Get returns the todo with the specified todos ID.
	...
	Update(ctx context.Context, id uuid.UUID, todo Todo) (*Todo, error)
	...
	// GetTypeTodo returns the typeTodo with the specified todos ID.
