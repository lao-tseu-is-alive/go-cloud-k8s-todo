...
func TestMainExec(t *testing.T) {
	...
	// common messages
	nameCannotBeEmpty := fmt.Sprintf(todo.FieldCannotBeEmpty, "name")
	nameMinLenghtMsg := fmt.Sprintf(todo.FieldMinLengthIsN, "name", todo.MinNameLength)
	...
	existingMaxTypetodoAppId += 1
	urTypetodoAppNewId := "/types/" + strconv.Itoa(existingMaxTypetodoAppId)
	...
	tests := []testStruct{
		...
		},
		{
			...
			paramKeyValues:               make(map[string]string, 0),
			httpMethod:                   http.MethodGet,
			url:                          defaultSecuredApi + urltodoApp,
			useFormUrlencodedContentType: false,
			useJwtToken:                  false,
			body:                         "",
		},
		{
			...
			paramKeyValues:               make(map[string]string, 0),
			httpMethod:                   http.MethodPost,
			url:                          defaultSecuredApi + urlTypetodoApp,
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
		...
		{
			name:                         "POST /types with valid JWT token should create a new typetodoApps",
			wantStatusCode:               http.StatusOK,
			contentType:                  MIMEHtmlCharsetUTF8,
			wantBody:                     "createdBy",
			paramKeyValues:               make(map[string]string, 0),
		...
		},
		{
			...
			paramKeyValues:               make(map[string]string),
			httpMethod:                   http.MethodGet,
			url:                          defaultSecuredApi + urlNewtodoAppId,
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
			body:                         "",
		},
		...
		{
			name:                         "GET /types with valid JWT token should return a list of TypetodoApps",
			wantStatusCode:               http.StatusOK,
			contentType:                  MIMEHtmlCharsetUTF8,
			wantBody:                     "createdAt",
			paramKeyValues:               make(map[string]string, 0),
		...
		{
			name:                         "GET /types with existing id should return the valid typetodoApp",
			wantStatusCode:               http.StatusOK,
			contentType:                  MIMEHtmlCharsetUTF8,
			wantBody:                     "\"id\":" + strconv.Itoa(existingMaxTypetodoAppId),
			paramKeyValues:               make(map[string]string, 0),
			httpMethod:                   http.MethodGet,
			url:                          defaultSecuredApi + urTypetodoAppNewId,
			useFormUrlencodedContentType: false,
			useJwtToken:                  true,
			body:                         "",
		},
		...
		{
			name:                         "PUT /types with existing id should return the valid typetodoApp",
			wantStatusCode:               http.StatusOK,
			contentType:                  MIMEHtmlCharsetUTF8,
		...
		{
			name:                         "GET /types with with existing external_id should return the valid typetodoApp",
			wantStatusCode:               http.StatusOK,
			contentType:                  MIMEHtmlCharsetUTF8,
			wantBody:                     "\"id\":" + strconv.Itoa(existingMaxTypetodoAppId),
			paramKeyValues:               make(map[string]string, 0),
		...
		{
			name:                         "GET /types with existing keyword should return the valid typetodoApp",
			wantStatusCode:               http.StatusOK,
			contentType:                  MIMEHtmlCharsetUTF8,
